...
//  BaseViewSample
//
//  Created by SASE Koichiro on 2020/08/24.
...
class SendTableViewController: UITableViewController, IndicatorInfoProvider {
    ...
    var toArray = ["佐藤s", "中野", "デスマッチドラゴン", "田中　将斗", "全斗煥", "SM女王", "狂猿", "オカダ　カズチカ", "タナカ　カクエイ", "千葉滋賀佐賀", "バーニングハンマー", "桜木しの", "毛沢東", "恐ろしい子", "月影先生", "姫川亜弓"]
